...
public class MyView2 extends HorizontalLayout {
    ...
    public MyView2() {
        ...
        goodSentence.setValue("test");
        VerticalLayout left = new VerticalLayout();
        VerticalLayout right = new VerticalLayout();

        left.add(word, addGoodWord, addBadWord, goodWord, badWord);
        right.add(sentence, addSentence, goodSentence, badSentence, showSentence);
